...
# specify path
path_to_trimmed_outfiles_v3 = '../outfiles_v3/trimmed_outfiles/'

with open(path_to_trimmed_outfiles_v3 + name_outfile, 'r+') as fp:
...
old_name = path_to_trimmed_outfiles_v3 + name_outfile
new_name = path_to_trimmed_outfiles_v3 + name_trimmed_outfile
