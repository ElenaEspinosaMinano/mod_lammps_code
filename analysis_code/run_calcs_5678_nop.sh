...
do
    for j in {3..5}
    do
        nohup python3 main_calcs_05678.py dump_model_${i}_var_${j}00_run_1.dat outfile_${i}_var_${j}00_run_3_v2.dat outfile_cs_${i}_var_${j}00_run_3_v2.dat 5${j}00 & disown
    done
done
