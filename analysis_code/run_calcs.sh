...
for k in {9..13}
do
    nohup python3 main_calculations.py dump_model_4_var_${k}_run_2.dat outfile_4_var_${k}_run_2.dat outfile_cs_4_var_${k}_run_2.dat &
    nohup python3 main_calculations.py dump_model_4_var_${k}_run_2_control.dat outfile_4_var_${k}_run_2_control.dat outfile_cs_4_var_${k}_run_2_control.dat &
done
